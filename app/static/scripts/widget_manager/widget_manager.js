...
export default class App {
    ...
    render(events) {
        const contentRegistredTableHTML = WidgetManagerTemplate.createTable(events);
        const contentHTML = WidgetManagerTemplate.createAppHTML(contentRegistredTableHTML, this.eventsList);
